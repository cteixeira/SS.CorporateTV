    ...
    DateRangePicker.prototype = {
        ...
        clickRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                if (window.location.href.toString().toLowerCase().indexOf("consulta") > -1) {

                    ActualizaListaConsultas();

                } else if (window.location.href.toString().toLowerCase().indexOf("prestador") > -1) {

                    ActualizaListaPrestadores();
                }
            }
        },

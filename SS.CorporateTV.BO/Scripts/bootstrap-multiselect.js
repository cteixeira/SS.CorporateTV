    ...
    Multiselect.prototype = {
        ...
        defaults: {
            ...
            buttonText: function(options, select) {
                if (options.length === 0) {
                    return '<div style="float: left;">' + this.nonSelectedText +
                        '</div><div style="float: right;">&nbsp;<b class="caret"></b></div>';
                }
                else if (options.length == $('option', $(select)).length) {
                    return '<div style="float: left;">' + this.allSelectedText+
                        '</div><div style="float: right;">&nbsp;<b class="caret"></b></div>';
                }
                else if (options.length > this.numberDisplayed) {
                    return '<div style="float: left;">' + options.length + ' ' + this.nSelectedText +
                        '</div><div style="float: right;">&nbsp;<b class="caret"></b></div>';
                }
                else {
                    var selected = '';
                    ...
                    return '<div style="float: left;">' + selected.substr(0, selected.length - 2) +
                        '</div><div style="float: right;">&nbsp;<b class="caret"></b></div>';
                }
            },
            /**
